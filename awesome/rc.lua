...
kbdcfg.add_primary_layout("Ελληνικά", "GR", "gr")
kbdcfg.bind()
...
beautiful.init("/home/antonis/.config/awesome/theme.lua")
...
local storage_home = awful.widget.watch("/home/antonis/.config/awesome/Scripts-AwesomeWM/disk-usage.sh", 60, function(self, stdout)
	st_home = stdout
...
local br, br_signal = awful.widget.watch(
	"/home/antonis/.config/awesome/Scripts-AwesomeWM/brightness-bar.sh",
	60,
...
local vo, vo_signal = awful.widget.watch("/home/antonis/.config/awesome/Scripts-AwesomeWM/volume-bar.sh", 60, function(self, stdout)
	local vol = stdout
...
awful.screen.connect_for_each_screen(function(s)
	...
	--s.my_tasklist = require("my_tasklist")(s)
...
globalkeys = gears.table.join(
  ...
  awful.key({"Mod1"}, "Shift_L", function () kbdcfg.switch_next() end, {description= "toggle language", group="hotkeys"}),
  ...
  awful.key({ modkey,           }, "s",      hotkeys_popup.show_help, {description="show help", group="awesome"}),
   ...
   -- User programs
    awful.key({ modkey }, "q", function () awful.spawn(browser) end, {description = "run browser", group = "launcher"}),
	...
	awful.key({ modkey,altkey }, "s", function()
		awful.spawn("scrot -q 100 /home/antonis/Pictures/Screenshots/%Y-%m-%d_$wx$h.png")
		naughty.notify({
			title = " ",
			fg = "#8293ce",
	...
	awful.key({ modkey, "Shift" }, "s", function()
		awful.spawn("scrot -s -q 100 /home/sv/Pictures/Screenshots/%Y-%m-%d_$wx$h.png")
   ...
   awful.key({}, "XF86AudioRaiseVolume", function ()
      awful.spawn("/home/antonis/.config/awesome/Scripts-AwesomeWM/volume-up.sh")
		vo_signal:emit_signal("timeout")
                               end,
              {description = "+5% volume", group = "hotkeys"}),
    awful.key({}, "XF86AudioLowerVolume", function ()
      awful.spawn("/home/antonis/.config/awesome/Scripts-AwesomeWM/volume-down.sh")
		  vo_signal:emit_signal("timeout")
                               end,
              {description = "-5% volume", group = "hotkeys"}),
    awful.key({}, "XF86AudioMute", function ()
		...
		vo_signal:emit_signal("timeout")
              ...
              {description = "Toggle mute volume", group = "hotkeys"}),
   awful.key({}, "XF86MonBrightnessUp", function ()
                                     awful.util.spawn("brightnessctl set 5%+")
                               end,
              {description = "+5% brighness", group = "hotkeys"}),
